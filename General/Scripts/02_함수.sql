...
SELECT 
	...
	TO_DATE('2024-12-06') - TO_DATE('2024-06-24')
FROM DUAL;
...
-- ADD_MONTH(날짜, 숫자) : 날짜를 숫자만큼의 개월 수를 더함
SELECT 
	CURRENT_DATE,
	CURRENT_DATE + 31,
	CURRENT_DATE + 61,
...
SELECT TO_CHAR(CURRENT_DATE, 'YYYY.MM.DD.(DY) AM HH24:MI:SS')
FROM DUAL;
...
SELECT TO_CHAR(CURRENT_DATE, 'YY"년" MM"월" DD"일" AM HH"시" MI"분" SS"초"')
FROM DUAL;
...
SELECT	
	...
	TO_DATE('49-12-25', 'RR-MM-DD')
FROM DUAL;

-- 50 이상 확인
SELECT
	TO_DATE('50-12-25', 'YY-MM-DD'),
	TO_DATE('50-12-25', 'RR-MM-DD')
FROM DUAL;

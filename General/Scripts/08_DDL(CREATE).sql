...
/* 자료형
    ...
    EX) VARCHAR2(3) 	: 가변길이 문자형 크기 3BYTE
    	  NVARCHAR2(3)  : 가변 길이 문자 3개까지 저장 가능 
...
INSERT INTO "MEMBER"
VALUES('MEM01', '123ABC', '홍길동', '990102-1234567', CURRENT_DATE);
...
CREATE TABLE USER_USED_UK(
    USER_NO NUMBER,
    --USER_ID VARCHAR2(20) UNIQUE, -- 컬럼 레벨 제약 조건 (제약 조건명 설정 X)
    USER_ID VARCHAR2(20) CONSTRAINT USER_ID_U UNIQUE, -- 컬럼 레벨 제약 조건 (제약 조건명 설정 O)
    -- 									 CONSTRAINT 제약 조건명  제약 조건 종류
    --										- 해당 컬럼의 "USER_ID_U"라는 이름의
    --                      UNIQUE 제약조건을 생성(설정)
     ...
     * */
--  UNIQUE(USER_ID) -- 테이블 레벨 제약 조건 설정(제약 조건명 X)
		CONSTRAINT USER_NAME_U UNIQUE(USER_NAME) -- 테이블 레벨 제약 조건 설정(제약 조건명 O)
...
CREATE TABLE USER_TEST(
	USER_NO NUMBER 				CONSTRAINT USER_NO_P 	PRIMARY KEY,
	USER_ID VARCHAR2(20) 	CONSTRAINT USER_ID_UQ UNIQUE,
	USER_PW VARCHAR2(20) 	CONSTRAINT USER_PW_NN NOT NULL,
	PNO 		CHAR(14) 			CONSTRAINT PNO_UQ 		UNIQUE,
	GENDER 	VARCHAR2(10) 	CONSTRAINT GENDER_CK 	CHECK ( GENDER IN ('남', '여') ),
	PHONE 	CHAR(13),
...
VALUES (
	1, 'USERID1', 'USERPW1', '990101-1234567', '남', '010-1234-1234', '서울시', 'N'
);
INSERT INTO USER_TEST
VALUES (
	2, 'USERID2', 'USERPW2', '990202-2345678', '여', '010-2345-2345', '경기도', 'N'
);
INSERT INTO USER_TEST
VALUES (
	3, 'USERID3', 'USERPW3', '990303-3456789', '남', '010-3456-3456', '강원도', 'N'
);
INSERT INTO USER_TEST
VALUES (
	4, 'USERID4', 'USERPW4', '990404-1212121', '여', '010-1212-1212', '충청도', 'N'
);
INSERT INTO USER_TEST
VALUES (
	5, 'USERID5', 'USERPW5', '990505-1233333', '남', '010-3333-3333', '서울시', 'N'
);
...
AS 
	SELECT EMP_NAME, NVL(DEPT_TITLE,'부서없음') AS DEPT_TITLE, JOB_NAME
	FROM EMPLOYEE
